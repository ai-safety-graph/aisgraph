          ...
          <div class="content-container narrow" style="flex: 1; padding: 2rem 3rem; background: white; border-radius: 12px; box-shadow: 0 2px 15px rgba(0,0,0,0.05);">
            <div style="display: flex; flex-direction: column; align-items: center;">
              ...
              <div style="display: flex; gap: 25px; justify-content: center; margin-top: 20px;">
                <a href="https://github.com/jackyzha0/quartz" target="_blank" style="display: flex; align-items: center; gap: 12px; padding: 12px 24px; border-radius: 8px; background: #f8f9fa; transition: all 0.2s; text-decoration: none; color: inherit; border: 1px solid #e9ecef;">
